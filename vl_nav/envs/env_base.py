...
from vl_nav.simulator import VLNSimulator


class VLNBaseEnv(gym.Env):
    '''
    ...
    def __init__(self,
        ...
        self.simulator = VLNSimulator(mode=mode,
